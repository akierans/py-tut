...
laser_weapon_armory = Room("Laser Weapon Armory",
	...
	tell the one Gothon joke you know: Lbhe zbgurevf fb sng, jura fur fvgf
	...
	in its container.  There's a keypad lock oin the box and you need the
	code to get the bomb out  If you get the code wrong 10 times then the
	lock closes forever and you can't get hte bomb. The code is 3 digits.
	""")
...
the_end_loser = Room("The End",
	"""
	You jump into a random pod and hit the eject button.  The pod escpaes
	out into the void of space, then implodeds as the hull ruptures, crushing
